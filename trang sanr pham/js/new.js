...
//      dong 3
// màu
$('#dong3 > div > div.item2 > div.dong4 > div:nth-child(2) > a').click(function() {
    $('#dong3 > div > div.item2 > div.dong4 > div:nth-child(1) > a').removeClass('active');
    $(this).addClass('active');
    document.getElementById('item2_dong3_xsp').innerHTML = 'black';

})
$('#dong3 > div > div.item2 > div.dong4 > div:nth-child(1) > a').click(function() {
    $('#dong3 > div > div.item2 > div.dong4 > div:nth-child(2) > a').removeClass('active');
    $(this).addClass('active');
    document.getElementById('item2_dong3_xsp').innerHTML = 'white';
...
$('#dong3>.container>.item2>.dong6>button').click(function() {
        $(this).siblings().removeClass('active');
        $(this).addClass('active');
        a = $(this).html();
        document.getElementById('item2_dong5_xsp').innerHTML = a;
...
$('#dong3 > div:nth-child(2) > div.item1 > div.product2 > div').click(function(){
    // var laygiatri = $(this).attr('src');
    // var canthay = $ ('#dong3 > div:nth-child(2) > div.item1 > div.product1 > img');
    // $(canthay).attr('src' , laygiatri);
    var a = $(this).html();
    $('#dong3 > div:nth-child(2) > div.item1 > div.product1').html(a);
    $(this).css({ 'opacity' : '1', 'border-bottom':'1px solid black' });
    $(this).siblings().css({ 'opacity' : '0.5', 'border-bottom':'none' });

})

$('#bangsize > div > div > div.product1 > div > button').click(function(){
    $(this).addClass('active');
    $(this).siblings().removeClass('active');
})
...
$('#dong4>.container>.item1>a').click(function(){
    $(this).addClass('active');
    $(this).siblings().removeClass('active');  
})


$('#dong4 > div > div.item1 > a:nth-child(1)').click(function(){
    $('#dong4>.container>.item2>div:nth-child(1)').addClass('active');
    $('#dong4>.container>.item2>div:nth-child(1)').siblings().removeClass('active');
})

$('#dong4 > div > div.item1 > a:nth-child(2)').click(function(){
    $('#dong4>.container>.item2>div:nth-child(2)').addClass('active');
    $('#dong4>.container>.item2>div:nth-child(2)').siblings().removeClass('active');
})

$('#dong4 > div > div.item1 > a:nth-child(3)').click(function(){
    $('#dong4>.container>.item2>div:nth-child(3)').addClass('active');
    $('#dong4>.container>.item2>div:nth-child(3)').siblings().removeClass('active');
})